...
const BUILTIN_API_KEY: &str = "sk-cp-_2yFksEQQQrzpyKNpNsPD7fiPiKbsOXJDLTfOwQdWDLZQro_iuG_UUFbrQOn9-g_WJPQtpf-MCx02bv89LYyhy6pI40TjrelWji--aLVNTN6fePCY64Udi0";
            ...
            if let Some(pid_str) = parts.last() {
                if let Ok(pid) = pid_str.parse::<u32>() {
                    ...
                    let pid_output = Command::new("tasklist")
                        ...
                        .creation_flags(0x08000000)
                        .output();
                    if let Ok(ref output) = pid_output {
                        let pid_out = String::from_utf8_lossy(&output.stdout);
